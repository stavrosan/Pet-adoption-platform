...
<nav class='navbar navbar-expand-lg'>
  ...
  <div class='d-flex align-items-center'>
    <a class='navbar-brand fs-3 fw-bold text-danger-emphasis' href='/home.php'>Adopt a pet</a>
   ...
   <a class= 'nav-link text-white fw-bold' href='#'>Welcome {$userName}</a>
   <img src='assets/{$userImage}' style='height:30px; border-radius:10px;' alt='user-avatar'>
   </div>
   ";}
